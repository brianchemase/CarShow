		...
		<section id="home" class="welcome-hero">
			...
			<div class="container">
				<div class="welcome-hero-txt">
					...
					<p>
						Your Number 1 car dealers in East and Central Africa. We offer nothing but the best. 
					</p>
					<button class="welcome-btn" onclick="window.location.href='#'">contact us</button>
				</div>
			</div>

			@include('filter.index')
			...
			<div class="container">
						...
						<div class="col-md-3 col-sm-6">
							<div class="single-footer-widget">
								<div class="footer-logo">
									<a href="index.html">GYBIRD Motors</a>
								</div>
								<p>
				...
				<div class="footer-copyright">
					<div class="row">
						<div class="col-sm-6">
							<p>
								&copy; copyright.designed and developed by Brian Anikayi.
							</p><!--/p-->
						</div>
						<div class="col-sm-6">
